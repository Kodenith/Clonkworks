...
private func BanList(){
  return([FTG1,FTG2,FTG3,FTG7,INSR,CNVS,CVS2,CHM2,ANV2,EXDR,EXDC,CT5P,TWR1,TWR2,FND2,I1MN]);
}
...
func Decide(){
  ...
  if(DoesInputHaveWire("Turn Right?")){
    if(InputActive("Turn Right?")) dirRight = 1;
    else dirRight = 0;
  }
