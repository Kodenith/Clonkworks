/*--- Kampfgesch�tz (angeschraubt) ---*/

#strict


/* �berladbar f�r andere Kanonen */
...
public func ComFire(object pClonk,bool Wired)
{
  SetAction("Attaching",GetActionTarget());
  SetRDir(0);
  ...
  if(Wired){
    ...
    if(Ammo) Shoot(0,Ammo,this,true);
...
private func Shoot(id defFoo, object pProjectile, object pShooter, bool Wired)
{
