...
global func SpawnPlatform(){
	...
	var Banned = [BAS7,CTW0,CST1,CST2,CST3,HUT1,HUT2,DRCK,ELEV,FNDR,GIDL,IDOL,IGLO,POWR,PUMP,RSRC,SAWM,SGNL,TWR2,BMBX,CT5P,AHUT,ACLD,MWKS,WZKP,ZIPP,CFUR,CELV];
